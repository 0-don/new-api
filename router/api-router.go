...
func SetApiRouter(router *gin.Engine, engine *fuego.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		dto.GetP(ch, "/status_history", controller.GetChannelStatusHistory, dto.PageParams())
		dto.GetP(ch, "/status_history/stats", controller.GetChannelFlapStats)
		dto.DeleteP(ch, "/status_history", controller.PruneChannelStatusHistory)
